...
This capstone project course will  gives a taste of what data scientists go through in real life when working with real datasets. There's assumed the role of a Data Scientist working for a startup intending to compete with SpaceX, and in the process follow the Data Science methodology involving data collection, data wrangling, exploratory data analysis, data visualization, model development, model evaluation, and reporting your results to stakeholders.
 

## 🎉 Labs completed by <a name="acknowledgments" href="https://github.com/MAAYAA-MOH">PURNIMA TRIPATHI</a>
